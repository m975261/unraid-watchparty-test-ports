...
## Docker Image
```
docker pull muaeabudhabi/watchparty-test-ports:latest
```

## Install on Unraid
1. Download `unraid-templates/my-watchparty-test-ports.xml`
2. Copy to `/boot/config/plugins/dockerMan/templates-user/`
3. Docker tab → Add Container → select `watchparty-test-ports`
